...
## [0.4.0](https://github.com/flybot-sg/oie/tree/v0.4.0) - 2026-08-24

### Fixed
- **`wrap-oauth2` intermittent "state mismatch"**: The OAuth2 state is mirrored into a per-flow cookie, so concurrent launches and racing session writes no longer erase the state mid-flow
